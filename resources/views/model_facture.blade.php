    ...
    <div class="box-container">
        ...
        <div class="transaction-box">
            ...
            <div class="item">
                ...
                <div class="value">Identifiant ici</div>
            </div>
            <div class="item">
                <div class="label">Nom & prénom:</div>
                <div class="value">Nom & Prénom ici (email ici)</div>
            </div>
            <div class="item">
                <div class="label">Département:</div>
                <div class="value">Département ici</div>
            </div>
            <div class="item">
                <div class="label">Mois & Année:</div>
                <div class="value">Mois / Année </div>
            </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Montant de paiement</td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="single_item"> <span>Total</span>
                                        <span class="value">Montant du paiement -Euro</span>
                                    </div>
                                </td>
                            </tr>
